...
Ryanair (RYR), lo cual puede ayudarnos de cara a una implementación estrategica
'''
...
output_model_path = '.\Output\model_tensorflow_filter_RYR.keras'
